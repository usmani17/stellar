...
export const CAMPAIGN_FIELD_LABELS: Record<string, string> = {
  ...
  logo_asset_id: "Logo asset",
  business_name_asset_id: "Business name asset",
  marketing_image_asset_id: "Marketing image asset",
  square_marketing_image_asset_id: "Square marketing image asset",
  headline_asset_ids: "Headlines",
  description_asset_ids: "Descriptions",
  long_headline_asset_ids: "Long headlines",
  video_asset_ids: "Videos",
  sitelink_asset_ids: "Sitelinks",
  callout_asset_ids: "Callouts",
