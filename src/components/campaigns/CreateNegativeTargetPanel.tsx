        ...
        <div className="flex items-end gap-3 mb-4">
          ...
          <div className="flex-1 min-w-[200px]">
            ...
            <input
              ...
              className={`campaign-input bg-white w-full px-4 py-2.5 border rounded-lg text-[11.2px] text-black focus:outline-none focus:ring-2 focus:ring-[#136D6D] focus:border-[#136D6D] ${errors.expressionValue || fieldErrors.expressionValue
                  ? "border-red-500"
                  : "border-gray-200"
                }`}
            />
