    ...
    <div className="bg-[#F9F9F6] border border-[#E8E8E3] rounded-xl">
              ...
              <tr>
                <th className="px-5 py-3 text-left border-b border-[#E8E8E3]">
                  <input
                    type="checkbox"
                    checked={
                      selectedRows.size === filteredChannels.length &&
                ...
                <th className="px-5 py-3 text-left text-[14px] font-medium text-[#29303f] border-b border-[#E8E8E3]">
                  Campaign Name
                </th>
                <th className="px-5 py-3 text-left text-[14px] font-medium text-[#29303f] border-b border-[#E8E8E3]">
                  Type
            ...
            <tbody>
              {filteredChannels.length === 0 ? (
                <tr>
                  <td
                    colSpan={11}
                    className="px-5 py-8 text-center text-[#556179]"
                  >
                    No channels found
                  </td>
                </tr>
                ...
                filteredChannels.map((channel) => {
                  ...
                  return (
                    <tr
                      key={channel.id}
                      className="border-b border-[#E8E8E3] hover:bg-[#FEFEFB]"
                    >
                      ...
                      <td className="px-5 py-4 text-[14px] text-[#0b0f16] font-normal">
                      ...
                      <td className="px-5 py-4">
                        <div className="flex items-center justify-center">
                          <button
                            ...
                            className="p-3 border border-gray-200 rounded-lg items-center hover:bg-gray-50 cursor-pointer"
                          >
                            <svg
      ...
      <div className="p-6 border-t border-[#E8E8E3] flex items-center justify-between">
        ...
        <div className="bg-white border border-[#EBEBEB] rounded-lg flex items-center">
          <button className="px-2.5 py-2.5 border-r border-gray-200 text-[14px] text-black hover:bg-gray-50 cursor-pointer">
            Previous
          </button>
          ...
          <button className="px-2.5 py-2.5 border-r border-gray-200 w-10 text-[14px] text-[#222124] hover:bg-gray-50">
            ...
          </button>
          <button className="px-2.5 py-2.5 border-r border-gray-200 w-10 text-[14px] text-black hover:bg-gray-50 cursor-pointer">
            5
          ...
          <button className="px-2.5 py-2.5 text-[14px] text-black hover:bg-gray-50 cursor-pointer ">
            Next
          </button>
        </div>
      </div>
