...
export const PerformanceChart: React.FC<PerformanceChartProps> = ({
  ...
  return (
    <div
      className={`graph-container ${isCollapsed ? "min-h-0 cursor-pointer" : ""}`}
      style={isCollapsed ? { borderRadius: "8px" } : undefined}
      onClick={isCollapsed ? handleContainerClick : undefined}
    >
      {/* Title and Metrics Dropdown */}
      <div className={`flex items-center ${isCollapsed ? "justify-start mb-0" : "justify-between mb-4"}`}>
