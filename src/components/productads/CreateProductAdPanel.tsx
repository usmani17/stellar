...
export const CreateProductAdPanel: React.FC<CreateProductAdPanelProps> = ({
  ...
  const [errors, setErrors] = useState<Partial<Record<keyof ProductAdInput, string>>>({});
  ...
  const validate = (): boolean => {
    ...
    if (currentProductAd.customText && currentProductAd.customText.length > 150) {
      ...
      <div className="p-4 border-b border-gray-200">
        ...
        <div className="flex flex-wrap items-end gap-3">
          ...
          <div className="flex-1 min-w-[200px]">
            ...
            />
            {errors.customText && (
              <p className="text-[10px] text-red-500 mt-1">{errors.customText}</p>
            )}
          </div>
          ...
          <div className="flex-1 min-w-[150px]">
            ...
            <input
              ...
              onChange={(e) => handleChange("catalogSourceCountryCode", e.target.value)}
              className="w-full px-3 py-2 border border-[#e8e8e3] rounded-lg text-[13.3px] text-[#0b0f16] focus:outline-none focus:ring-2 focus:ring-[#136D6D] focus:border-transparent"
          ...
          <div className="flex-1 min-w-[120px]">
            ...
            <Dropdown<string>
              ...
              onChange={(value) => handleChange("state", value as "ENABLED" | "PAUSED")}
          ...
          <div className="flex-shrink-0">
            <button
              ...
              className="px-4 py-2 bg-[#136D6D] text-white border border-[#136D6D] rounded-lg hover:bg-[#0e5a5a] transition-colors text-[11.2px] font-semibold whitespace-nowrap"
            >
              Add
            </button>
          </div>
                ...
                <table className="w-full min-w-max">
                  ...
                  <tbody>
                    {addedProductAds.map((productAd, index) => {
                      const adGroupName = adgroups.find(
