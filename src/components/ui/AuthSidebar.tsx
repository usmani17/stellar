      ...
      <div className="relative z-10 flex flex-col gap-28 px-16 py-28 w-full">
        <div className="w-full max-w-[590px] flex flex-col gap-10">
          {showGetStarted && (
            ...
            >
              <span className="text-white text-2xl font-normal uppercase leading-8 tracking-tight" className="font-poppins">
                Let's go
              </span>
            </Link>
          )}
          ...
          {children || (
            <div className="flex flex-col gap-10">
              <h2 className="text-4xl font-semibold text-white leading-10 tracking-tight" className="font-poppins">
                know your numbers. Grow with<br/>clarity
              </h2>
              <p className="text-2xl text-white font-normal leading-8 tracking-tight" className="font-poppins">
              ...
              <div className="flex flex-col gap-5">
                <div className="inline-flex gap-5">
                  <div className="px-5 py-3 bg-white/20 rounded-3xl backdrop-blur flex justify-center items-center gap-2.5">
                    ...
                    <span className="text-white text-base font-normal leading-5 tracking-tight" className="font-poppins">Google</span>
                  </div>
                  <div className="px-5 py-3 bg-white/20 rounded-3xl backdrop-blur flex justify-center items-center gap-2.5">
                    <div className="w-5 h-5 relative rounded-[3px]">
                      <div className="w-3.5 h-3.5 left-[3.29px] top-[2.50px] absolute bg-white" />
                    </div>
                    <span className="text-white text-base font-normal leading-5 tracking-tight" className="font-poppins">Walmart</span>
                  </div>
                  <div className="px-5 py-3 bg-white/20 rounded-3xl backdrop-blur flex justify-center items-center gap-2.5">
                    <div className="w-5 h-5 relative rounded-[3px]">
                      <div className="w-3.5 h-3.5 left-[3.28px] top-[2.50px] absolute bg-white" />
                    </div>
                    <span className="text-white text-base font-normal leading-5 tracking-tight" className="font-poppins">Instacart</span>
                  </div>
                </div>
                <div className="inline-flex gap-5">
                  <div className="px-5 py-3 bg-white/20 rounded-3xl backdrop-blur flex justify-center items-center gap-2.5">
                    ...
                    <span className="text-white text-base font-normal leading-5 tracking-tight" className="font-poppins">Criteo</span>
                  </div>
                  <div className="px-5 py-3 bg-white/20 rounded-3xl backdrop-blur flex justify-center items-center gap-2.5">
                    <div className="w-5 h-5 relative">
                      <div className="w-4 h-4 left-[1.67px] top-[2.50px] absolute bg-white" />
                    </div>
                    <span className="text-white text-base font-normal leading-5 tracking-tight" className="font-poppins">Amazon</span>
                  </div>
                </div>
              </div>
            </div>
