        ...
        <div className="p-6">
          ...
          <div className="mb-4">
            ...
            <p className="text-[14px] text-[#556179]">
              Are you sure you want to delete <span className="font-medium text-[#313850]">"{itemName}"</span>?
            </p>
          </div>
          ...
          <div className="flex items-center justify-end gap-3">
            ...
            <Button
              ...
              size="sm"
              disabled={isLoading}
              className="bg-red-600 hover:bg-red-700 focus:ring-red-500 border-red-600"
            >
              {isLoading ? (
