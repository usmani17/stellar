...
import { Banner, Button, Loader, Tooltip } from "../components/ui";
      ...
      >
        ...
        <div className="px-4 py-6 sm:px-6 lg:p-8 bg-white">
          <div className="space-y-6">
            ...
            <div
              className="bg-[#fefefb] border border-[#e8e8e3] rounded-[12px] overflow-x-auto overflow-y-visible relative"
              style={{ minHeight: isLoading ? "400px" : undefined }}
            >
              {(isLoading || isFetching) && (
                <div className="loading-overlay">
                  <div className="loading-overlay-content">
                    <Loader size="md" message={isLoading ? "Loading strategies..." : "Updating..."} />
                  </div>
                </div>
              )}
                                                              ...
                                                              .then((res) => {
                                                                ...
                                                                const totalNetChange =
                                                                  typeof res
                                                                    .total_net_change ===
                                                                    "number"
                                                                    ? res.total_net_change
                                                                    : null;
                                                                const totalNetChangePct =
                                                                  typeof res
                                                                    .total_net_change_pct ===
                                                                    "number"
                                                                    ? res.total_net_change_pct
                                                                    : null;
                                                                setPreviewTotalNetChange(
                                                                  totalNetChange,
                                                                );
