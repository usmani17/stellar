...
interface TargetsTabProps {
  ...
  failedCount: number;
  failedTargets: any[];
  onClearFailedTargetAtIndex?: (index: number) => void;
    ...
    <>
      ...
      {isCreatePanelOpen && (
        <CreateTargetPanel
          ...
          onRemoveTargetAtIndex={onClearFailedTargetAtIndex}
        />
      )}

      {/* Bid editor panel for Targets - same UI as main Campaigns / Keywords page */}
