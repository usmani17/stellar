...
export const GoogleCreateCampaign: React.FC = () => {
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              <Button
                onClick={() => {
                  if (accountId) {
                    navigate(buildMarketplaceRoute(parseInt(accountId), "google", "campaigns"));
                  }
                }}
                variant="outline"
              >
            ...
            <div className="bg-[#f9f9f6] border border-[#e8e8e3] rounded-[12px] p-8 text-center">
              ...
              <p className="text-[12px] text-[#556179]">
                This page will allow you to create new Google Ads campaigns.
              </p>
            </div>
          </div>
        </div>
