...
import { DraftToggle } from "../../../../components/ui";
import {
  FilterPanel,
  type FilterValues,
...
interface GoogleCampaignDetailAssetGroupsTabProps {
  ...
  onPublishDraftAssetGroup?: (assetGroup: GoogleAssetGroup) => void;
}
...
> = ({
  ...
  return (
    <>
      ...
      {/* Draft switch - above table (label inside switch, same as Ad Groups) */}
      {onToggleDraftsOnly != null && (
        <div className="flex items-center mb-4">
          <DraftToggle checked={showDraftsOnly} onChange={() => onToggleDraftsOnly()} />
        </div>
      )}
                          ...
                          {isDraftAssetGroup(assetGroup) &&
                            onPublishDraftAssetGroup && (
                              <button
                                ...
                                onClick={(e) => {
                                  e.stopPropagation();
                                  onPublishDraftAssetGroup(assetGroup);
                                }}
