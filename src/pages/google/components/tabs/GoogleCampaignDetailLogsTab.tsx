...
export const GoogleCampaignDetailLogsTab: React.FC<GoogleCampaignDetailLogsTabProps> = ({
  ...
  const loadLogs = useCallback(async () => {
    ...
    try {
      ...
      console.error("Error loading Google logs:", error);
      if (error?.response) {
          ...
          <div className="w-full flex justify-between items-center">
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="px-2 py-1 bg-white border border-[#E3E3E3] rounded text-sm text-[#072929] focus:outline-none focus:border-[#136D6D]"
              >
