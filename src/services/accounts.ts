...
export type BrandKbTriggerType =
  | "brand_level"
  | "integration_level"
  | "profile_level";
...
export const accountsService = {
  ...
  deleteBrandKbEntry: async (brandId: number, kbId: number): Promise<void> => {
  ...
  handleTikTokOAuthCallback: async (
    ...
    const response = await api.post<Channel>(
      "/accounts/tiktok-oauth/callback/",
      {
  ...
  getProfiles: async (
    ...
    const response = await api.get<{
      ...
      total: number;
      selected: number;
    }>(`/accounts/channels/${channelId}/profiles/`);
    return response.data;
  },
  ...
  getTikTokProfiles: async (
    ...
    const response = await api.get<{
      ...
      total: number;
      selected: number;
    }>(`/accounts/channels/${channelId}/tiktok-profiles/`);
    return response.data;
  },
  ...
  getPortfolios: async (
    ...
    }>(`/accounts/${accountId}/portfolios/`, { params });
  ...
  getBrandEntities: async (
    ...
    }>(`/accounts/${accountId}/brand-entities/`, { params });
